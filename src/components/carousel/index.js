    ...
    >
      <SwiperSlide className="h-full">
        <div className="h-full w-3/5 flex items-center overflow-hidden px-24">
          <Image src={Image1} className="absolute top-0 left-0 object-cover -z-10" />
          <div className="space-y-4 bg-slate-600 p-8 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 saturate-150 border border-gray-100">
            <h1 className="text-7xl font-bold">All your Freight Problems Answered</h1>
            <p className="text-lg">Lorem Ipsum Dolor Sit Amet akldaskaskl adklasdklna akldnasknd aklsnd</p>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="h-full w-3/5 flex items-center overflow-hidden px-24">
          <Image src={Image2} className="absolute top-0 left-0 object-cover -z-10" />
          <div className="space-y-4 bg-slate-600 p-8 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 saturate-150 border border-gray-100">
            <h1 className="text-7xl font-bold">All your Freight Problems Answered</h1>
            <p className="text-lg">Lorem Ipsum Dolor Sit Amet akldaskaskl adklasdklna akldnasknd aklsnd</p>
          </div>
